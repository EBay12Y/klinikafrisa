...
$alamat=$_POST["alamat"];
                ...
                if($update){
                    echo "<script>alert('Selamat! Data Berhasil diubah'); window.location = 'index.php'</script>"; 
              ...
              <div class="card">
                ...
                <form class="forms-sample" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="password"  id="exampleInputConfirmPassword2" value="<?php echo $data['password']; ?>"  placeholder="Password">
                      </div>
                    </div>
