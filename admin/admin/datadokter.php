                 ...
                 <br>
                    ...
                    <td><center><?php echo $data['alamat']; ?></center></td>
                     ...
                     <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Data Admin" href="edit_dokter.php?aksi=edit&id_dokter=<?php echo $data['id_dokter'];?>"><span class="glyphicon glyphicon-edit"></span>Ubah data</a>  
                       ...
                       <a onclick="return confirm ('Yakin untuk menghapus data? <?php echo $data['id_dokter'];?>');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data dokter" href="datadokter.php?aksi=hapus&id_dokter=<?php echo $data['id_dokter'];?>">Hapus <span class="glyphicon glyphicon-trash"></a></center>
