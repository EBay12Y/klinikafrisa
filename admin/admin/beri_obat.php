...
$nama_beri_obat=$_POST["nama_beri_obat"];
$level="User";


 $cek = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM pemeriksaan_dokter_obat WHERE id_beri_obat='$id_beri_obat'"));

 if ($cek > 0){
 echo "<script>window.alert('anda sudah melakukan pengisian  ')
 window.location='pemeriksaan_dokter.php'</script>";
 }else {
 mysqli_query($kon, "INSERT INTO pemeriksaan_dokter_obat (id_beri_obat, nama_beri_obat) VALUES ('$id_beri_obat', '$nama_beri_obat')");
...
<!-- 
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Beri Obat</h4>
                        <p class="card-description">
                            <BR>
                        </p>
                        <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card">
                                        <form class="forms-sample" action="Konfirmasi_pemeriksaan.php" method="post">
                                            ...
                                            <input name="id_beri_obat" type="hidden" id="id_beri_obat" class="form-control" placeholder="Tidak perlu di isi" value="<?php $a = "beriobat";
                                                                                                                                                            $b = rand(1000, 10000);
                                                                                                                                                            $c = $a . $b;
                                                                                                                                                            echo $c; ?>" autofocus="on" readonly="readonly" />
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Obat yang diberikan</label>

                                                <input type="text" class="form-control" id="nama_beri_obat" name="nama_beri_obat" placeholder="Masukkan keluhan pasien">
