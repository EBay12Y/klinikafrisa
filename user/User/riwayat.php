        ...
        <div class="content-wrapper">
          <div class="row">
             <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Riwayat Pasien Berobat</h4>
                  ...
                  <div class="table-responsive">
                       ...
                       <?php
                    $query1="select * from pendaftaran INNER JOIN  dokter ON pendaftaran.nama_poli = dokter.nama_poli WHERE id_user='$_SESSION[id_user]' AND status='ok' ";
                    ...
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <th><center>Tanggal Berobat </center></th>
