          ...
          <div class="row">
              ...
              <div class="col-md-7 form-part">
                <div class="row">
                  ...
                  echo "<script>alert('Username atau password Anda salah. Silakan coba lagi!'); window.location = 'login.php'</script>"; 

              }
                          ?>

                   <p class="signinlink">Belum Punya akun? <a href="index.php"> Daftar disini</a></p>
                   <br><br>
